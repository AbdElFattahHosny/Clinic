    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_VisitTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Visit_Medicines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Visit_Medicines_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Visit_Medicines_Visits_VisitId",
                        column: x => x.VisitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visit_Medicines_MedicineId",
                table: "Visit_Medicines",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_Visit_Medicines_VisitId",
                table: "Visit_Medicines",
                column: "VisitId");
